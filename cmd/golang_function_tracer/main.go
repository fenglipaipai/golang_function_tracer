...
import (
	...
	"github.com/hanzhongzi/golang_function_tracer/instrumenter"
	"github.com/hanzhongzi/golang_function_tracer/instrumenter/ast"
)
...
func main() {
	...
	ins = ast.New("github.com/hanzhongzi/golang_function_tracer", "trace", "Trace")
